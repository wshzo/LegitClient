...
public class MoveUtil {
    ...
    public static float adjustYaw(float yaw, float forward, float strafe) {
        TargetStrafe targetStrafe = (TargetStrafe) LegitClient.moduleManager.modules.get(TargetStrafe.class);
