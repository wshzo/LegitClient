        ...
        if (event.getType() == EventType.POST) {
            if (this.reverseFlag
                    ...
                    this.canDelay()
                            ...
                            || LegitClient.delayManager.isDelay() >= (long) this.delayTicks.getValue()
            )) {
                LegitClient.delayManager.setDelayState(false, DelayModules.VELOCITY);
                ...
                if (packet.getEntityID() == mc.thePlayer.getEntityId()) {
                    ...
                    if (this.mode.getValue() == 2
                        ...
                        if (this.delayChanceCounter >= 100) {
                            LegitClient.delayManager.setDelayState(true, DelayModules.VELOCITY);
