...
import legitclient.events.PlayerUpdateEvent;
import legitclient.module.Module;
import legitclient.util.PlayerUtil;
import legitclient.util.RandomUtil;
...
public class AntiVoid extends Module {
    ...
    private void resetBlink() {
        LegitClient.blinkManager.setBlinkState(false, BlinkModules.ANTI_VOID);
        this.lastSafePosition = null;
    }

    private boolean canUseAntiVoid() {
        LongJump longJump = (LongJump) LegitClient.moduleManager.modules.get(LongJump.class);
