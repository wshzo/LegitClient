    ...
    public void onTick(TickEvent event) {
        if (this.isEnabled()) {
            switch (event.getType()) {
                case PRE:
                    LegitClient.lagManager.setDelay(0);
                    ...
                    if ((!bedNuker.isEnabled() || !bedNuker.isReady())
                        ...
                        if (players.isEmpty()) {
                            ...
                            Vec3 eyePosition = LegitClient.lagManager.getLastPosition().addVector(0.0, height, 0.0);
                            ...
                            for (EntityPlayer player : players) {
                                ...
                                if (!(distance > (double) this.range.getValue())) {
                                    ...
                                    if (distance < targetDist || distance < eyeDist) {
                                        ...
                                        LegitClient.lagManager.setDelay(this.tickIndex);
                                        this.hasTarget = true;
                                        return;
                                    }
                                }
                    ...
                    break;
                case POST:
                    Vec3 savedPosition = LegitClient.lagManager.getLastPosition();
