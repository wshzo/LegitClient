...
import legitclient.events.ResizeEvent;
import legitclient.mixin.IAccessorEntityRenderer;
...
import legitclient.util.shader.GlowShader;
import legitclient.util.shader.OutlineShader;
    ...
    private Color getEntityColor(EntityPlayer entityPlayer) {
        if (TeamUtil.isFriend(entityPlayer)) {
            ...
            switch (this.color.getValue()) {
                ...
                case 2:
                    int hudColor = ((HUD) LegitClient.moduleManager.modules.get(HUD.class)).getColor(System.currentTimeMillis()).getRGB();
