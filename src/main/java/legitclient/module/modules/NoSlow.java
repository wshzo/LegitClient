...
import legitclient.events.RightClickMouseEvent;
import legitclient.module.Module;
import legitclient.util.BlockUtil;
...
public class NoSlow extends Module {
    ...
    public void onPlayerUpdate(PlayerUpdateEvent event) {
        if (this.isEnabled() && this.isFloatMode()) {
            ...
            if (this.lastSlot != item && PlayerUtil.isUsingItem()) {
                this.lastSlot = item;
                LegitClient.floatManager.setFloatState(true, FloatModules.NO_SLOW);
            }
        } else {
            this.lastSlot = -1;
            LegitClient.floatManager.setFloatState(false, FloatModules.NO_SLOW);
        }
    }
    ...
    public void onRightClick(RightClickMouseEvent event) {
        if (this.isEnabled()) {
            ...
            if (this.isFloatMode() && !LegitClient.floatManager.isPredicted() && mc.thePlayer.onGround) {
