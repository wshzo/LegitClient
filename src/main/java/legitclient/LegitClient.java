...
import legitclient.command.CommandManager;
import legitclient.command.commands.*;
import legitclient.config.Config;
import legitclient.event.EventManager;
import legitclient.management.*;
import legitclient.module.Module;
import legitclient.module.ModuleManager;
import legitclient.module.modules.*;
import legitclient.property.Property;
import legitclient.property.PropertyManager;

import java.lang.reflect.Field;
import java.util.ArrayList;

public class LegitClient {
    public static String clientName = "&f[&bLc&f]&r ";
